...
当前状态：In Progress。OpenAI-compatible provider、embedding queue 和 sqlite-vec 写入/重建已完成；Profile Algorithm、Ranking v1 和 Explanation v1 仍待完成。
...
1. `R-11 / R-12 / M3-05 / M3-06`: Profile Algorithm v0 and Ranking v1。
2. `R-14 / R-15 / M2-07 / M2-08 / M2-12`: Docker, MVP E2E smoke, and user docs。
3. `M1-12 / R-16`: Read progress capture and Search v0。
